...
Version  : 5.15.17
Release  : 33
URL      : https://download.qt.io/official_releases/qt/5.15/5.15.17/submodules/qtquickcontrols-everywhere-opensource-src-5.15.17.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.15/5.15.17/submodules/qtquickcontrols-everywhere-opensource-src-5.15.17.tar.xz
...
%prep
%setup -q -n qtquickcontrols-everywhere-src-5.15.17
cd %{_builddir}/qtquickcontrols-everywhere-src-5.15.17
...
ASFLAGS="$CLEAR_INTERMEDIATE_ASFLAGS"
LDFLAGS="$CLEAR_INTERMEDIATE_LDFLAGS"
export SOURCE_DATE_EPOCH=1748650470
rm -rf %{buildroot}
