...
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.3/submodules/qtquickcontrols-everywhere-src-5.12.3.tar.xz
...
%prep
%setup -q -n qtquickcontrols-everywhere-src-5.12.3
...
%install
export SOURCE_DATE_EPOCH=1556928805
rm -rf %{buildroot}
