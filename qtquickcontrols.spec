...
Version  : 5.13.1
Release  : 19
URL      : https://download.qt.io/official_releases/qt/5.13/5.13.1/submodules/qtquickcontrols-everywhere-src-5.13.1.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.13/5.13.1/submodules/qtquickcontrols-everywhere-src-5.13.1.tar.xz
...
%prep
%setup -q -n qtquickcontrols-everywhere-src-5.13.1
...
%install
export SOURCE_DATE_EPOCH=1568399249
rm -rf %{buildroot}
