...
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.1/submodules/qtquickcontrols-everywhere-src-5.12.1.tar.xz
...
%prep
%setup -q -n qtquickcontrols-everywhere-src-5.12.1
...
%install
export SOURCE_DATE_EPOCH=1549046095
rm -rf %{buildroot}
