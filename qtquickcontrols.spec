...
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.4/submodules/qtquickcontrols-everywhere-src-5.12.4.tar.xz
...
%prep
%setup -q -n qtquickcontrols-everywhere-src-5.12.4
...
%install
export SOURCE_DATE_EPOCH=1561156906
rm -rf %{buildroot}
