...
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.2/submodules/qtquickcontrols-everywhere-src-5.12.2.tar.xz
...
%prep
%setup -q -n qtquickcontrols-everywhere-src-5.12.2
...
%install
export SOURCE_DATE_EPOCH=1552686002
rm -rf %{buildroot}
